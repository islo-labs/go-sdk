...
var (
	disconnectCustomIntegrationRequestFieldProvider  = big.NewInt(1 << 0)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (d *DisconnectCustomIntegrationRequest) SetProvider(provider string) {
	d.Provider = provider
	d.require(disconnectCustomIntegrationRequestFieldProvider)
}
