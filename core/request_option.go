...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.APIVersion != "" {
		header.Set("X-Islo-Api-Version", fmt.Sprintf("%v", r.APIVersion))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/islo-labs/go-sdk")
	headers.Set("X-Fern-SDK-Version", "v0.0.0")
	headers.Set("User-Agent", "github.com/islo-labs/go-sdk/0.0.0")
	return headers
}
