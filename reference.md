...
<details><summary><code>client.Factories.GetScopedFactoryMetrics(FactoryID) -> *gosdk.FactoryMetricsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Factories.GetScopedFactoryLineMetrics(FactoryID, Name) -> *gosdk.LineMetricsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Factories.TriggerScopedFactoryLineWebhook(FactoryID, Name, request) -> *gosdk.LineRunDetail</code></summary>
<dl>
<dd>
...
**message:** `string` — Instruction or context for the line run's manager
