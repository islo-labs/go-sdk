...
func TestCreditsGetCreditBalanceWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Credits.GetCreditBalance(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestCreditsGetCreditBalanceWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestCreditsGetCreditBalanceWithWireMock", "GET", "/credits/balance", nil, 1)
}
